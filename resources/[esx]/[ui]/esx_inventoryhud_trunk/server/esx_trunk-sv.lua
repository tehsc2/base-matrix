...
RegisterServerEvent("ddx_trunk_inventory:getOwnedVehicule")
AddEventHandler(
  "ddx_trunk_inventory:getOwnedVehicule",
  function()
    local vehicules = {}
    ...
    MySQL.Async.fetchAll(
      ...
      function(result)
        ...
        TriggerClientEvent("ddx_trunk_inventory:setOwnedVehicule", _source, vehicules)
      end
    )
  end
)
...
RegisterServerEvent("ddx_trunk:getItem")
AddEventHandler(
  "ddx_trunk:getItem",
      ...
      if targetItem.limit == -1 or ((targetItem.count + count) <= targetItem.limit) then
        TriggerEvent(
          ...
          function(store)
            ...
            TriggerClientEvent("ddx_inventoryhud:refreshTrunkInventory", _source, data, blackMoney, items, weapons)
          end
        )
      else
        TriggerClientEvent(
...
RegisterServerEvent("ddx_trunk:putItem")
AddEventHandler(
  "ddx_trunk:putItem",
