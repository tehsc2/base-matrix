...
RegisterServerEvent("ddx_inventoryhud:tradePlayerItem")
AddEventHandler(
	"ddx_inventoryhud:tradePlayerItem",
...
RegisterCommand(
	...
	function(source, args, rawCommand)
		if IsPlayerAceAllowed(source, "inventory.openinventory") then
			...
			if targetXPlayer ~= nil then
				TriggerClientEvent("ddx_inventoryhud:openPlayerInventory", source, target, targetXPlayer.name)
			else
